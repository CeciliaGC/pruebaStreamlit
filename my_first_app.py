...
housing_price_df=read_csv('C:/Users/cecil/Documents/cursos/Streamlit/state_market_tracker.tsv000.gz')
...
@st.cache #comando que guarda la data en cache para que no se vuelva a cargar cada vez que el usuario refresca el explorador

def read_file(path):
    return gpd.read_file(path)

#Read the geojson file
gdf = read_file('C:/Users/cecil/Documents/cursos/Streamlit/us-state-boundaries.geojson')
#st.write(gdf.head())
...
#a partir de aca todo va para la web

#st.write(str('1,2,3 probando...'))
...
choropleth1 = folium.Choropleth(
    geo_data='C:/Users/cecil/Documents/cursos/Streamlit/us-state-boundaries.geojson',     #This is the geojson file for the Unite States
